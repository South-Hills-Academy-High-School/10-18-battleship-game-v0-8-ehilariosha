...
controller.up.onEvent(ControllerButtonEvent.Pressed, function () {
    ...
    grid.place(phantomCursor, tiles.getTileLocation(grid.spriteCol(cursor), grid.spriteRow(cursor) + 1))
})
...
controller.left.onEvent(ControllerButtonEvent.Pressed, function () {
    ...
    grid.place(phantomCursor, tiles.getTileLocation(grid.spriteCol(cursor) + 1, grid.spriteRow(cursor)))
})
...
cursor = sprites.create(img`
    ...
    3 3 3 3 3 . . . . . . 3 3 3 3 3 
    `, SpriteKind.Cursor)
phantomCursor = sprites.create(img`
    ........................
    ........................
    ........................
    ........................
    ...
    if (moveBoatFlag == 1) {
        ...
        if (isOverlapping()) {
            if (rotateFlag != "nothing") {
                ...
                grid.place(cursor, grid.getLocation(phantomCursor))
            }
        }
    }
})
